...
* To clarify, you are to submit the following email patch files:
    * Email patch file 0 p0/firstname_lastname
    * Patch 1 adds your Makefile, creating p0/firstname_lastname
	* Each subsequent patch `N` implement step `N-2` listed on
		[P0](/course/fall2023/assignments/P0.md). E.g, patch 5 implements step 2
...
* Read through the [E1]() assignment page and check out this [completed demo](https://kdlp.underground.software/cgit/e1_demo/)
...
# *ALL P0 SUBMISSIONS GO TO: [programming@kdlp.underground.software](mailto:programming0@kdlp.underground.software)*
